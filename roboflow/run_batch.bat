@echo off
REM Usage: run_batch.bat <image_list_path> [api_key] [project_id] [project_version] [results_dir]
...
python -m a2.annotate --image_list "%~1" --target_annotation_directory "%RESULTS_DIR%" --roboflow_project_id "%PROJECT_ID%" --roboflow_project_version %PROJECT_VERSION% --roboflow_api_key "%API_KEY%"
